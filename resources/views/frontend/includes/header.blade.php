    ...
    <div class="container">
      ...
      <!-- <div class="lang-wrap">
        ...
        <ul class="lang-tooltip green-bg">
          ...
          <li><a href="#"><img src="http://easybook.kwst.net/images/lan/5.png" alt=""> It</a></li>
  ...
  <div class="header-inner fl-wrap">
    <div class="container">
      ...
      <div class="header-user-menu">
        ...
        <ul>
          <li><a href="{{url('/user-dashboard')}}"> Edit profile</a></li>
      ...
      <div class="home-btn">
        ...
        <a href="{{url('/')}}"><i class="fas fa-home"></i></a></div>
      <!-- nav-button-wrap-->
      ...
      <div class="nav-holder main-menu">
        <nav>
          <ul>
            <li>
              <a href="{{url('/')}}" class="act-link">Home <!-- <i class="fas fa-caret-down"></i> --></a>
              <!--second level -->
              <!-- <ul>
            ...
            <li>
              <a href="{{url('/listing')}}">Listings <!-- <i class="fas fa-caret-down"></i> --></a>
              <!--second level -->
              <!-- <ul>
      ...
      <div class="wishlist-wrap scrollbar-inner novis_wishlist">
        <div class="box-widget-content">
          <div class="widget-posts fl-wrap">
            <ul>
              <li class="clearfix">
                <a href="#"  class="widget-posts-img"><img src="http://easybook.kwst.net/images/gal/7.jpg" class="respimg" alt=""></a>
              ...
              <li class="clearfix">
                <a href="#"  class="widget-posts-img"><img src="http://easybook.kwst.net/images/gal/8.jpg" class="respimg" alt=""></a>
                <div class="widget-posts-descr">
              ...
              <li class="clearfix">
                <a href="#"  class="widget-posts-img"><img src="http://easybook.kwst.net/images/gal/9.jpg" class="respimg" alt=""></a>
                <div class="widget-posts-descr">
